...
- `Male-cost`, `Female-cost`, `budget` sont les curseurs de contraintes budgétaires. {budget} est le montant affecté à chaque couple pour l'ensemble de ses naissances. {M-cost} et F-cost} sont respectivement les couts d'élevage d'un mâle et d'une femelle.
